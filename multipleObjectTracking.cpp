...
int main(int argc, char* argv[])
{
	...
	capture.open("video-1539252198.mp4");
	//open capture object at location zero (default location for webcam)
	//capture.open("http://cluster.dystopi.nu/stream/eye.flv");
	...
	while(1){
		...
		//delay that screen can refresh. (should be 30ms but i used 1ms becuse of delay problems?)
